...
},{"./VuetablePaginationMixin.vue":11,"vue":5,"vue-hot-reload-api":2}],9:[function(require,module,exports){
'use strict';
...
},{"./VuetablePaginationMixin.vue":11,"vue":5,"vue-hot-reload-api":2}],10:[function(require,module,exports){
'use strict';
...
},{"./VuetablePaginationMixin.vue":11,"vue":5,"vue-hot-reload-api":2}],11:[function(require,module,exports){
'use strict';
...
Vue.component('custom-action', {
    template: ['<div>', '<button @click="itemAction(\'view-item\', rowData)"><i class="glyphicon glyphicon-zoom-in"></i></button>', '<button @click="itemAction(\'edit-item\', rowData)"><i class="glyphicon glyphicon-pencil"></i></button>', '<button @click="itemAction(\'delete-item\', rowData)"><i class="glyphicon glyphicon-remove"></i></button>', '</div>'].join(''),
    props: {
        rowData: {
            type: Object,
            required: true
...
Vue.component('my-detail-row', {
    template: ['<div class="detail-row ui form" @click="onClick($event)">', '<div class="inline field">', '<label>Name: </label>', '<span>{{rowData.name}}</span>', '</div>', '<div class="inline field">', '<label>Email: </label>', '<span>{{rowData.email}}</span>', '</div>', '<div class="inline field">', '<label>Nickname: </label>', '<span>{{rowData.nickname}}</span>', '</div>', '<div class="inline field">', '<label>Birthdate: </label>', '<span>{{rowData.birthdate}}</span>', '</div>', '<div class="inline field">', '<label>Gender: </label>', '<span>{{rowData.gender}}</span>', '</div>', '</div>'].join(''),
    props: {
        rowData: {
            type: Object,
            required: true
...
},{"vue":5,"vue-resource":3,"vue-strap/dist/vue-strap.min.js":4,"vuetable/src/components/Vuetable.vue":7,"vuetable/src/components/VuetablePagination.vue":8,"vuetable/src/components/VuetablePaginationBootstrap.vue":9,"vuetable/src/components/VuetablePaginationDropdown.vue":10}]},{},[12]);
