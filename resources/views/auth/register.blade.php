                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                         ...
                         <div class="form-group{{ $errors->has('firts_name') ? ' has-error' : '' }}">
                            <label for="firts_name" class="col-md-4 control-label">First Name</label>

                            <div class="col-md-6">
                                <input id="firts_name" type="text" class="form-control" name="firts_name" value="{{ old('firts_name') }}">
                        ...
                        <div class="form-group{{ $errors->has('type_person_id') ? ' has-error' : '' }}">
                            <label for="type_person_id" class="col-md-4 control-label">Type person</label>
                            ...
                            <div class="col-md-6">
                                ...
                                @if ($errors->has('type_person_id'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('type_person_id') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
